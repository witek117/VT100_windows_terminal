...
class Bar : public Box, public Number {
    size_t oldBarStatus = 0;          // to note the change between new value and old value, used in refresh_value function
  ...
  public:
     ...
     */
    Bar(const char *title, const char *unit, bool isEditable, void (*event_function)(), uint16_t divider = 1, int min = 0, int max = 100);
